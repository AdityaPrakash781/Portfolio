...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <Link href={`/projects/${project.id}`}>
      <div className="group relative w-full h-full glass-card rounded-xl overflow-hidden p-5 sm:p-8 cursor-pointer flex flex-col hover:-translate-y-1 transition-transform duration-300">
